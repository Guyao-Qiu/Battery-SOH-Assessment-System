...
license: Apache 2.0
metadata:
  security: "offline-guidance-only"
  upstream: "impeccable 4.0.4"
---
...
This Codex edition is guidance-only. It contains no executable scripts, hooks, live server, telemetry, update checker, image API client, or browser automation. Do not invoke commands from the upstream project as part of this skill. Use Codex's built-in image generation capability separately when the user explicitly asks for an image.
...
| `live` | Disabled | Upstream browser/live-server mode is intentionally excluded from this safe edition. | — |
...
**Pin / Unpin:** Disabled in this safe edition because upstream pin scripts are not included.

**Hooks:** Disabled in this safe edition. Do not install or enable upstream hooks.

**Doctor:** Not included. This safe edition does not run drift repair or update checks.
